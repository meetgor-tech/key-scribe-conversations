...
export function Sidebar({ 
  ...
  return (
    <aside className={cn(
      "bg-slate-900/50 backdrop-blur-xl border-r border-slate-700/50 flex flex-col transition-all duration-300 h-full",
      collapsed ? "w-16" : "w-80"
    )}>
      {/* Header */}
      <div className={cn("p-4 border-b border-slate-700/50", collapsed && "px-2")}>
        ...
        {collapsed && (
          <Button 
            className="w-full bg-blue-600 hover:bg-blue-700 text-white border-0 p-2"
            onClick={handleNewChat}
          >
